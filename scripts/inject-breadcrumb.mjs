...
//
// This is a parallelization-friendly arrangement: adding or renaming a topic
// only mutates js/section-map.js + the affected topic + index.html, instead
// of rewriting the inlined map in every topic page (the prior layout caused
// every topic-add PR to touch all 190 topic HTMLs and content/*.json).
//
...
//                flags js/section-map.js drift if present. Exits 0 (audit mode
//                does not fail CI — the --fix step is the remediator; this
//                mode exists so humans can see drift).
...
const sectionMapJsContent =
  '// Auto-generated by scripts/inject-breadcrumb.mjs from index.html.\n' +
