...
const SPECIAL = new Set(['index.html', 'pathway.html', 'widgets.html', 'mindmap.html', 'tags.html', 'search.html', 'updates.html', 'whos-who.html', 'open-problems.html', 'counterexamples.html']);
