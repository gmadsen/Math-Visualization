# elementary-topos-theory-chi-pullback

Bespoke registry entry for a widget on `elementary-topos-theory.html`. Carries the
...
Embed two blocks (widget + widget-script) into `content/elementary-topos-theory.json`,
