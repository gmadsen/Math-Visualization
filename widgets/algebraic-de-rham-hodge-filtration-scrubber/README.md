# algebraic-de-rham-hodge-filtration-scrubber

Proof-scrubber walkthrough of the Hodge filtration $F^\bullet$ on de Rham cohomology, used in algebraic-de-rham-cohomology.html §4.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-hodge-filtration-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-hodge-filtration-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
