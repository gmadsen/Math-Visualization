# algebraic-de-rham-hodge-pn-explorer

Slider-driven explorer of the Hodge numbers $h^{p,q}$ for projective space $\mathbb{P}^n$. Used in algebraic-de-rham-cohomology.html §5.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-hodge-pn-explorer", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-hodge-pn-explorer", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
