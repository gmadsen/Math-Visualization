...
export function renderScript(params) {
  ...
  return (
    ...
    `  var XL=0, XR=10, PX0=44, PX1=420, PTOP=46, PBOT=210, YLO=-2, YHI=4;\n` +
    `  var Va=3, Vb=7;\n` +  // sub-open V
