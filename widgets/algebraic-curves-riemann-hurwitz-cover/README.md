# algebraic-curves-riemann-hurwitz-cover

Click-on-SVG cover diagram illustrating the Riemann–Hurwitz formula for a smooth projective curve cover. Used in algebraic-curves-higher-genus.html §1.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-riemann-hurwitz-cover", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-riemann-hurwitz-cover", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
