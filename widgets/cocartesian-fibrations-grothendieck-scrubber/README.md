# cocartesian-fibrations-grothendieck-scrubber

Proof-scrubber walkthrough of the Grothendieck construction $\int F$. Used in cocartesian-fibrations.html §5.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-grothendieck-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-grothendieck-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
