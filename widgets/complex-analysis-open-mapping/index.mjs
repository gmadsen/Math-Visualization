...
export function renderScript(params) {
  ...
  return (
    ...
    `    } else {\n` +
    `      lines.push('The boundary image does NOT wind around f(z\\u2080) (winding 0): f(z\\u2080) sits on the boundary of the image, which is just a segment \\u2014 it has empty interior in \\u2102.');\n` +
