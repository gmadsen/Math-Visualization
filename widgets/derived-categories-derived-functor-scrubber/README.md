# derived-categories-derived-functor-scrubber

Bespoke proof-scrubber walking through the construction of total derived functors $\mathrm{R}F$ on a triangulated category, used in derived-categories.html §5 (#derived-functors-triangulated).
...
```json
{ "type": "widget",        "slug": "derived-categories-derived-functor-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "derived-categories-derived-functor-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
