...
Cmb w2 widget — scaffolded stub. Replace this paragraph with a short
...
TODO(cmb-w2): one paragraph describing the interaction. What does the reader
...
TODO(cmb-w2): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "cmb-w2", "params": { "widgetId": "w-cmb-w2", "title": "Cmb w2" } },
{ "type": "widget-script", "slug": "cmb-w2", "params": { "widgetId": "w-cmb-w2", "title": "Cmb w2" } }
```
