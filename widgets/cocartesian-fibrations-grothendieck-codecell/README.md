# cocartesian-fibrations-grothendieck-codecell

Inline-code cell sandbox for experimenting with the Grothendieck construction. Used in cocartesian-fibrations.html §6.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-grothendieck-codecell", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-grothendieck-codecell", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
