# infinity-categories-functor-levels

Bespoke widget showing how a map of simplicial sets $\mathcal{C} \to \mathcal{D}$ encodes the higher coherence data of an $\infty$-functor, used in infinity-categories.html §3 (#infty-functors).
...
```json
{ "type": "widget",        "slug": "infinity-categories-functor-levels", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "infinity-categories-functor-levels", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
