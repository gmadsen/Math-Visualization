...
Kf gain widget — scaffolded stub. Replace this paragraph with a short
...
TODO(kf-gain): one paragraph describing the interaction. What does the reader
...
TODO(kf-gain): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "kf-gain", "params": { "widgetId": "w-kf-gain", "title": "Kf gain" } },
{ "type": "widget-script", "slug": "kf-gain", "params": { "widgetId": "w-kf-gain", "title": "Kf gain" } }
```
