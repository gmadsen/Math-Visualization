// matroid-bases-rank-explorer widget — bespoke registry entry for the §2 bases & rank widget
// on the `matroid-theory` topic.
//
// The widget combines a $U_{r,n}$ uniform-matroid explorer with two rank sliders, a test-subset input, an SVG that draws every $r$-subset basis, and a readout reporting the rank $r(S) = \min(|S|, r)$. The shape is bespoke; this slug
