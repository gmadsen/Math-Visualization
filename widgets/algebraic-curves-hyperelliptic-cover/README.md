# algebraic-curves-hyperelliptic-cover

Click-on-SVG illustration of a hyperelliptic curve as a 2-to-1 cover of $\mathbb{P}^1$. Used in algebraic-curves-higher-genus.html §5.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-hyperelliptic-cover", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-hyperelliptic-cover", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
