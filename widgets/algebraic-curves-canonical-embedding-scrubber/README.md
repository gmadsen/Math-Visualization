# algebraic-curves-canonical-embedding-scrubber

Proof-scrubber walkthrough of the canonical embedding $C \hookrightarrow \mathbb{P}^{g-1}$. Used in algebraic-curves-higher-genus.html §4.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-canonical-embedding-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-canonical-embedding-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
