# derived-categories-chain-homotopy

Bespoke clickable widget displaying a chain homotopy $h: f \simeq g$ between two chain maps, used in derived-categories.html §1 (#homotopy-category).
...
```json
{ "type": "widget",        "slug": "derived-categories-chain-homotopy", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "derived-categories-chain-homotopy", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
