# algebraic-curves-riemann-roch-scrubber

Proof-scrubber walkthrough of the Riemann–Roch theorem for a smooth projective curve. Used in algebraic-curves-higher-genus.html §3.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-riemann-roch-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-riemann-roch-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
