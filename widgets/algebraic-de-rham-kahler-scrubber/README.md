# algebraic-de-rham-kahler-scrubber

Proof-scrubber walkthrough of $\Omega^1_{A/k}$ as the universal recipient of $k$-derivations, used in algebraic-de-rham-cohomology.html §1.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-kahler-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-kahler-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
