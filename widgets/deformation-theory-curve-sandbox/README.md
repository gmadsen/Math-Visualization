# deformation-theory-curve-sandbox

Bespoke sandbox visualizing first-order deformations of a fixed curve, used in deformation-theory.html §6 (#deformation-of-a-curve).
...
```json
{ "type": "widget",        "slug": "deformation-theory-curve-sandbox", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "deformation-theory-curve-sandbox", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
