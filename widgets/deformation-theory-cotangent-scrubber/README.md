# deformation-theory-cotangent-scrubber

Bespoke proof-scrubber walking through the cotangent complex $L_{X/S}$ in degrees $0, -1, -2$, used in deformation-theory.html §5 (#cotangent-complex).
...
```json
{ "type": "widget",        "slug": "deformation-theory-cotangent-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "deformation-theory-cotangent-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
