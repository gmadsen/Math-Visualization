...
export function renderScript(params) {
  ...
  return (
    ...
    `    if(g===1 && jac===1 && !qr){ txt(36, cy+24, 'CAVEAT: ('+a+'/'+n+') = +1  but  '+a+' is NOT a square mod '+n+'.', {size:12, fill:'var(--orange)', weight:600}); txt(36, cy+42, 'the \\u22121 Legendre factors cancel in pairs \\u2014 but a is a QR mod n only if EVERY (a/p\\u1d62)=+1', {size:10, fill:'var(--mute)', italic:true}); }\n` +
    `    else if(g===1 && jac===-1){ txt(36, cy+24, '(\\u2212 sign \\u21d2 at least one factor (a/p\\u1d62) = \\u22121 \\u21d2 '+a+' is NOT a square mod '+n+')', {size:10, fill:'var(--mute)', italic:true}); }\n` +
