# cocartesian-fibrations-transport-clickable

Click-on-SVG explorer of fibers and the transport functor along an edge. Used in cocartesian-fibrations.html §4.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-transport-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-transport-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
