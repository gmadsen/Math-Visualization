# cocartesian-fibrations-fibration-clickable

Click-on-SVG explorer of a cocartesian fibration $p\colon E \to B$. Used in cocartesian-fibrations.html §3.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-fibration-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-fibration-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
