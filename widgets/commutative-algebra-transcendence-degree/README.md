# commutative-algebra-transcendence-degree

Bespoke registry entry for the `w-tr` widget on
`commutative-algebra.html`. Carries the widget's full `<div class="widget" id="…">…</div>`
...
Embed two blocks (widget + widget-script) into `content/commutative-algebra.json`,
