...
export function renderScript(params) {
  ...
  return (
    ...
    `    txt(PX0, PTOP-6, 'log |P(e\\u00b2\\u1d56\\u2071\\u1d52)|   \\u2014   m = mean height (dashed line)', {size:9, fill:'var(--mute)'});\n` +
