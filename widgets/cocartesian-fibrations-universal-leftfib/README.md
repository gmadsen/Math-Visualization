# cocartesian-fibrations-universal-leftfib

Static SVG illustrating the equivalence between left fibrations and presheaves. Used in cocartesian-fibrations.html §6.
...
```json
{ "type": "widget", "slug": "cocartesian-fibrations-universal-leftfib", "params": { "widgetId": "...", "bodyMarkup": "..." } }
```
