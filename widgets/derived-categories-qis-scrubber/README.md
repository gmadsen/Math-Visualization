# derived-categories-qis-scrubber

Bespoke proof-scrubber walking through how a quasi-isomorphism induces an isomorphism on cohomology, used in derived-categories.html §2 (#quasi-isomorphisms).
...
```json
{ "type": "widget",        "slug": "derived-categories-qis-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "derived-categories-qis-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
