# grothendieck-topologies-sites-sieves-poset

Bespoke registry entry for a widget on `grothendieck-topologies-sites.html`. Carries the
...
Embed two blocks (widget + widget-script) into `content/grothendieck-topologies-sites.json`,
