...
export function renderScript(params) {
  ...
  return (
    ...
    `      note:'Conductor N = 37, prime; this is the famous rank-1 curve y\\u00b2+y = x\\u00b3\\u2212x (its Mordell\\u2013Weil group is infinite, generated by (0,0)). Level 37 has two weight-2 newforms \\u2014 both with rational (integer) coefficients \\u2014 attached to the two isogeny classes; f = 37.2.a.a is the analytic-rank-1 one matching this E (37.2.a.b is the rank-0 class).'},\n` +
    `  ];\n` +
    ...
    `    if(!C) return;\n` +
    `    svg.setAttribute('aria-label','Modularity for the elliptic curve '+C.k+' of conductor '+C.N+': for every good prime p, a_p of the curve (from counting points over the prime field) equals the coefficient a_p of the weight-2 newform '+C.nf+', shown agreeing on every row.');\n` +
