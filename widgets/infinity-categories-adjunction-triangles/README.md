# infinity-categories-adjunction-triangles

Bespoke widget showing the unit/counit triangle identities for an $\infty$-adjunction $F \dashv G$, used in infinity-categories.html §5 (#infty-adjunctions).
...
```json
{ "type": "widget",        "slug": "infinity-categories-adjunction-triangles", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "infinity-categories-adjunction-triangles", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
