...
Kf cycle widget — scaffolded stub. Replace this paragraph with a short
...
TODO(kf-cycle): one paragraph describing the interaction. What does the reader
...
TODO(kf-cycle): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "kf-cycle", "params": { "widgetId": "w-kf-cycle", "title": "Kf cycle" } },
{ "type": "widget-script", "slug": "kf-cycle", "params": { "widgetId": "w-kf-cycle", "title": "Kf cycle" } }
```
