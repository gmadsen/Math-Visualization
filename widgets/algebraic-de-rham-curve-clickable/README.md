# algebraic-de-rham-curve-clickable

Click-on-SVG worked example of de Rham cohomology for a smooth projective curve, used in algebraic-de-rham-cohomology.html §6.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-curve-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-curve-clickable", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
