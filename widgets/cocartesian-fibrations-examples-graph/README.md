# cocartesian-fibrations-examples-graph

Click-on-graph examples of cocartesian fibrations. Used in cocartesian-fibrations.html §7.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-examples-graph", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-examples-graph", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
