...
To upgrade this widget into a bespoke renderer with semantic params (slider ranges, color tokens, etc.), replace `widgets/toric-varieties-w5/index.mjs` with a custom `renderMarkup` / `renderScript` and update the schema accordingly.
