...
export function renderScript(params) {
  ...
  return (
    ...
    `      note:'\\u221b2 is a root of x\\u00b3\\u22122, irreducible over \\u211a (Eisenstein at 2), so [\\u211a(\\u221b2):\\u211a]=3 with \\u211a-basis {1, \\u221b2, \\u221b4}. Note \\u211a(\\u221b2) is NOT the splitting field of x\\u00b3\\u22122 \\u2014 it is missing the complex roots \\u221b2\\u00b7\\u03c9; the full splitting field has degree 6.' },\n` +
