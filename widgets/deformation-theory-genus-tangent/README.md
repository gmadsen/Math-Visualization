# deformation-theory-genus-tangent

Bespoke widget showing $\dim_k \mathrm{Def}_{C}(D) = 3g - 3$ as a function of curve genus $g$, used in deformation-theory.html §6 (#deformation-of-a-curve).
...
```json
{ "type": "widget",        "slug": "deformation-theory-genus-tangent", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "deformation-theory-genus-tangent", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
