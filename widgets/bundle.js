...
window.__MVWidgets = [
  ...
  {
    "slug": "hamiltonians-canonical-transform",
    "family": "hamiltonians-canonical-transform",
    "dimension": "2d",
    "gesture": "slider",
    "role": "exploratory",
    "title": "hamiltonians-canonical-transform widget params",
    "description": "Bespoke widget for the §3 canonical transformations preview on the hamiltonians-classical-mechanics topic. Renders a single .row containing both a `<select>` (map family: rotation / shear / squeeze / a non-canonical control case) and a `<input type=\"range\">` parameter slider, then an SVG host showing a unit square transported by the chosen linear map, plus a readout reporting whether |det J| = 1. The select-AND-slider-on-the-same-row layout is bespoke; parametric-plot's pick row is a separate row from its slider row.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §3 canonical-transformations preview on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#canonical) topic.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
  ...
  {
    "slug": "hamiltonians-conserved-quantity",
    "family": "hamiltonians-conserved-quantity",
    "dimension": "2d",
    "gesture": "select",
    "role": "exploratory",
    "title": "hamiltonians-conserved-quantity widget params",
    "description": "Bespoke widget for the §4 conserved-quantity tracker on the hamiltonians-classical-mechanics topic. Renders one .row containing two `<select>`s side-by-side (System: oscillator / central / gravity; Track: H / p / L) plus an SVG host that plots the chosen quantity along a flow integration. The two-pickers-on-one-row layout is bespoke; no shared slug exposes a multi-pick row.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §4 conserved-quantity tracker on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#noether) topic.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
  ...
  {
    "slug": "hamiltonians-flow-portrait",
    "family": "hamiltonians-flow-portrait",
    "dimension": "2d",
    "gesture": "click",
    "role": "exploratory",
    "title": "hamiltonians-flow-portrait widget params",
    "description": "Bespoke widget for the §2 Hamiltonian flow portrait on the hamiltonians-classical-mechanics topic — the signature phase-space-portrait gesture: pick a Hamiltonian from a <select>, see the vector field rendered into the SVG, and click anywhere in the field to drop an initial condition that integrates forward under the flow. The combination of select + click-on-SVG + step/clear buttons + a hint <span class='small'> trailing the buttons does not fit any shared slug; this slug captures it as a single unit.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §2 Hamiltonian flow portrait on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#hamilton-eq) topic — the topic's signature interactive.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
  ...
  {
    "slug": "hamiltonians-kam-tori",
    "family": "hamiltonians-kam-tori",
    "dimension": "2d",
    "gesture": "slider",
    "role": "exploratory",
    "title": "hamiltonians-kam-tori widget params",
    "description": "Bespoke widget for the §5 KAM-tori illustration on the hamiltonians-classical-mechanics topic. Three `<input type=\"range\">` sliders ($\\omega_1$, $\\omega_2$, $\\varepsilon$) all share a single .row above an SVG host showing a 2-torus orbit (closed curve when the frequency ratio is rational, dense winding when irrational, perturbed under a small KAM-style coupling). The all-sliders-in-one-row layout is bespoke; parametric-plot puts each slider in its own row.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §5 KAM-tori illustration on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#integrable) topic.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
  ...
  {
    "slug": "hamiltonians-kepler-orbits",
    "family": "hamiltonians-kepler-orbits",
    "dimension": "2d",
    "gesture": "slider",
    "role": "exploratory",
    "title": "hamiltonians-kepler-orbits widget params",
    "description": "Bespoke widget for the §6 Kepler-orbits sweep on the hamiltonians-classical-mechanics topic. Two `<input type=\"range\">` sliders ($E$, $L$) share a single .row above an SVG host showing the conic orbit (ellipse / parabola / hyperbola) parametrized by energy and angular momentum. The two-sliders-in-one-row layout matches `hamiltonians-kam-tori` (3 sliders) but is distinct from parametric-plot's per-row layout.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §6 Kepler-orbits sweep on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#applications) topic.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
  ...
  {
    "slug": "hamiltonians-phase-space-cell",
    "family": "hamiltonians-phase-space-cell",
    "dimension": "2d",
    "gesture": "button",
    "role": "exploratory",
    "title": "hamiltonians-phase-space-cell widget params",
    "description": "Bespoke widget for the §1 phase-space cell on the hamiltonians-classical-mechanics topic. Renders an SVG host plus two action buttons (play/reset) and a readout reporting the cell's area, centroid, and shape. The buttons-only gesture (no sliders, no select) doesn't fit any shared slug; this slug captures it as a single unit and carries the bespoke draw logic in the bodyScript artifact.",
    "requiredParams": [
      "widgetId",
      "svgId",
      "outputId",
    ...
    "readmeExcerpt": "Bespoke widget for the §1 phase-space cell on the [`hamiltonians-classical-mechanics`](../../hamiltonians-classical-mechanics.html#phase-space) topic.",
    "hasExample": false,
    "exampleParams": null,
    "exampleMarkup": null,
    "exampleScript": null
