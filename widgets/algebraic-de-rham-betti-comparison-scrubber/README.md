# algebraic-de-rham-betti-comparison-scrubber

Proof-scrubber walkthrough of the Betti / algebraic de Rham comparison theorem over $\mathbb{C}$, used in algebraic-de-rham-cohomology.html §3.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-betti-comparison-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-betti-comparison-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
