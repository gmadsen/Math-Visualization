...
Cmb w7 widget — scaffolded stub. Replace this paragraph with a short
...
TODO(cmb-w7): one paragraph describing the interaction. What does the reader
...
TODO(cmb-w7): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "cmb-w7", "params": { "widgetId": "w-cmb-w7", "title": "Cmb w7" } },
{ "type": "widget-script", "slug": "cmb-w7", "params": { "widgetId": "w-cmb-w7", "title": "Cmb w7" } }
```
