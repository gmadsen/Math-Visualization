...
export function renderScript(params) {
  ...
  return (
    ...
    `    txt(TX,ty,'hardest n \\u2264 100: '+arg+' needs '+mx,{size:10,fill:'var(--pink)',weight:600}); ty+=16;\n` +
