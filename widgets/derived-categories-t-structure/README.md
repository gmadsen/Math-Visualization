# derived-categories-t-structure

Bespoke widget for a t-structure $(D^{\le 0}, D^{\ge 0})$ with cohomology functors $H^n$, used in derived-categories.html §6 (#t-structures).
...
```json
{ "type": "widget",        "slug": "derived-categories-t-structure", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "derived-categories-t-structure", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
