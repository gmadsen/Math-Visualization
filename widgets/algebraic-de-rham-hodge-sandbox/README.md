# algebraic-de-rham-hodge-sandbox

Sandbox for assembling Hodge diamonds from genus + dimension data, used in algebraic-de-rham-cohomology.html §6.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-hodge-sandbox", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-hodge-sandbox", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
