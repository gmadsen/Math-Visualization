...
Cmb w6 widget — scaffolded stub. Replace this paragraph with a short
...
TODO(cmb-w6): one paragraph describing the interaction. What does the reader
...
TODO(cmb-w6): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "cmb-w6", "params": { "widgetId": "w-cmb-w6", "title": "Cmb w6" } },
{ "type": "widget-script", "slug": "cmb-w6", "params": { "widgetId": "w-cmb-w6", "title": "Cmb w6" } }
```
