...
Kf fusion widget — scaffolded stub. Replace this paragraph with a short
...
TODO(kf-fusion): one paragraph describing the interaction. What does the reader
...
TODO(kf-fusion): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "kf-fusion", "params": { "widgetId": "w-kf-fusion", "title": "Kf fusion" } },
{ "type": "widget-script", "slug": "kf-fusion", "params": { "widgetId": "w-kf-fusion", "title": "Kf fusion" } }
```
