# cocartesian-fibrations-edge-scrubber

Proof-scrubber walkthrough of the cocartesian-edge lifting condition. Used in cocartesian-fibrations.html §2.
...
```json
{ "type": "widget",        "slug": "cocartesian-fibrations-edge-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "cocartesian-fibrations-edge-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
