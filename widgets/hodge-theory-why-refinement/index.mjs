...
export function renderScript(params) {
  ...
  return (
    ...
    `  var VARS=[\n` +
    `    {k:'E', nm:'an elliptic curve', deg:[{n:0,b:1,h:[[0,0,1]]},{n:1,b:2,h:[[1,0,1],[0,1,1]]},{n:2,b:1,h:[[1,1,1]]}]},\n` +
    ...
    `    if(!V) return;\n` +
    `    txt(20, 22, 'X = '+V.nm+'.  '+((mode==='top')?'topological view: only the Betti numbers b\\u2099 = dim H\\u207f are visible':'Hodge view: H\\u207f(X;\\u2102) = \\u2295_{p+q=n} H^{p,q}'), {size:10.5, fill:(mode==='top')?'var(--mute)':'var(--violet)', weight:600});\n` +
