...
Cmb w3 widget — scaffolded stub. Replace this paragraph with a short
...
TODO(cmb-w3): one paragraph describing the interaction. What does the reader
...
TODO(cmb-w3): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "cmb-w3", "params": { "widgetId": "w-cmb-w3", "title": "Cmb w3" } },
{ "type": "widget-script", "slug": "cmb-w3", "params": { "widgetId": "w-cmb-w3", "title": "Cmb w3" } }
```
