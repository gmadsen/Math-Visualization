// group-schemes-hopf-scrubber widget — bespoke registry entry.
//
// Bespoke proof-scrubber walkthrough showing how the Hopf-algebra structure on the coordinate ring $\mathcal{O}(G)$ encodes the group-scheme axioms, used in §3 of group-schemes.html (#hopf-algebra).
//
