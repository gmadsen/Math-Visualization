# algebraic-curves-jacobian-lattice

Lattice visualizer of the Jacobian variety $\mathrm{Jac}(C)$ as a complex torus. Used in algebraic-curves-higher-genus.html §2.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-jacobian-lattice", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-jacobian-lattice", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
