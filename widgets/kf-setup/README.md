...
Kf setup widget — scaffolded stub. Replace this paragraph with a short
...
TODO(kf-setup): one paragraph describing the interaction. What does the reader
...
TODO(kf-setup): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "kf-setup", "params": { "widgetId": "w-kf-setup", "title": "Kf setup" } },
{ "type": "widget-script", "slug": "kf-setup", "params": { "widgetId": "w-kf-setup", "title": "Kf setup" } }
```
