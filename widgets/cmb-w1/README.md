...
Cmb w1 widget — scaffolded stub. Replace this paragraph with a short
...
TODO(cmb-w1): one paragraph describing the interaction. What does the reader
...
TODO(cmb-w1): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "cmb-w1", "params": { "widgetId": "w-cmb-w1", "title": "Cmb w1" } },
{ "type": "widget-script", "slug": "cmb-w1", "params": { "widgetId": "w-cmb-w1", "title": "Cmb w1" } }
```
