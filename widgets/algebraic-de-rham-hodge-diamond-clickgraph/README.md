# algebraic-de-rham-hodge-diamond-clickgraph

Click-on-SVG explorer of the Hodge diamond — pick a $(p,q)$ entry, see the matching cohomology group $H^q(X,\Omega^p)$. Used in algebraic-de-rham-cohomology.html §5.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-hodge-diamond-clickgraph", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-hodge-diamond-clickgraph", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
