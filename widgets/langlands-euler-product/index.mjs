...
export function renderScript(params) {
  ...
  return (
    ...
    `    lines.push('');\n` +
    `    lines.push('The equality of these Euler products IS the bridge; strong multiplicity one (Jacquet\\u2013Shalika) makes L a complete invariant, and the functional equation \\u039b(s) = \\u00b1\\u039b(2\\u2212s) pins it down.');\n` +
