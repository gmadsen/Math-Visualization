# algebraic-curves-moduli-boundary

Click-on-SVG explorer of the boundary of $\overline{\mathcal{M}}_g$ — stable curves with nodes. Used in algebraic-curves-higher-genus.html §6.
...
```json
{ "type": "widget",        "slug": "algebraic-curves-moduli-boundary", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-curves-moduli-boundary", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
