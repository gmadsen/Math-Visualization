# algebraic-de-rham-complex-scrubber

Proof-scrubber walkthrough of the algebraic de Rham complex $\Omega^\bullet_{X/k}$ and its hypercohomology, used in algebraic-de-rham-cohomology.html §2.
...
```json
{ "type": "widget",        "slug": "algebraic-de-rham-complex-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "algebraic-de-rham-complex-scrubber", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
