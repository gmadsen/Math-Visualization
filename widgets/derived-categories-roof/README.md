# derived-categories-roof

Bespoke widget illustrating the roof / fraction calculus $X \xleftarrow{\sim} Z \to Y$ in $D(\mathcal{A})$, used in derived-categories.html §3 (#derived-category).
...
```json
{ "type": "widget",        "slug": "derived-categories-roof", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } },
{ "type": "widget-script", "slug": "derived-categories-roof", "params": { "widgetId": "...", "bodyMarkup": "...", "bodyScript": "..." } }
```
