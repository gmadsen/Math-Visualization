...
export function renderScript(params) {
  ...
  return (
    ...
    `    txt(36, 244, 'B is '+(defNeg?'NEGATIVE-DEFINITE \\u21d2 compact group':(pos===3?'POSITIVE-DEFINITE':(zero>0?'DEGENERATE \\u21d2 not semisimple':'INDEFINITE \\u21d2 noncompact (split) group'))), {size:12, fill:defNeg?'var(--green)':(zero>0?'var(--pink)':'var(--cyan)'), weight:600});\n` +
