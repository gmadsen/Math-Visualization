// group-schemes-mu-n-add widget — bespoke registry entry.
//
// Companion clock widget visualizing $\mathbb{Z}/n\mathbb{Z}$ under addition (the constant group scheme analogue), used in §2 of group-schemes.html (#examples-Ga-Gm) alongside the multiplicative $\mu_n$ widget.
//
