// simplicial-sets-nerve-2simplex widget — bespoke registry entry.
//
// Clickable 3-object category showing how composable pairs assemble 2-simplices in N(C). Used in §4 of simplicial-sets-and-nerve.html.
//
