...
Kf track widget — scaffolded stub. Replace this paragraph with a short
...
TODO(kf-track): one paragraph describing the interaction. What does the reader
...
TODO(kf-track): extend this table as you add params to `schema.json`.
...
```json
{ "type": "widget",        "slug": "kf-track", "params": { "widgetId": "w-kf-track", "title": "Kf track" } },
{ "type": "widget-script", "slug": "kf-track", "params": { "widgetId": "w-kf-track", "title": "Kf track" } }
```
