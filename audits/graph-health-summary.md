...
- Total concepts: **711**
- Total prereq edges: **1192**
- Implicit prereq candidates (total across all concepts): **218**
- Multi-topic candidates (title appears in prose of ≥ 3 other topics): **27**
- Atomicity-split candidates (blurb ≥ 3 sentences AND > 200 chars): **68**
- Dangling proper-noun phrases (in ≥ 2 topics, no matching concept): **26**
- Orphan concepts (zero edges in or out): **0**

## Decision framework

- ✅ **implicit_prereqs ≥ 200** (218): edge enrichment first. The existing graph has too many missing dependencies to benefit from restructuring.

## Top 15 multi-topic candidates

- `open-sets` (point-set-topology) — title appears in prose of **9** other topics
- `compactness` (point-set-topology) — title appears in prose of **9** other topics
- `fundamental-group` (algebraic-topology) — title appears in prose of **8** other topics
- `analytic-continuation` (complex-analysis) — title appears in prose of **7** other topics
- `cc-vector-bundles` (characteristic-classes) — title appears in prose of **7** other topics
...
- `holomorphic-function` (complex-analysis) — title appears in prose of **4** other topics
- `brownian-motion` (probability-theory) — title appears in prose of **4** other topics
- `connectedness` (point-set-topology) — title appears in prose of **4** other topics
- `modularity-theorem` (modularity-and-flt) — title appears in prose of **4** other topics
...
- `chern-classes` (intersection-theory-chow) — 3 missing: cc-chern-classes, cc-vector-bundles, cc-euler-class
...
- `hf-maximum-principle` (harmonic-functions) — 2 missing: connectedness, harmonic-functions
- `hf-harnack-inequality` (harmonic-functions) — 2 missing: harmonic-functions, holomorphic-function
- `brownian-motion` (probability-theory) — 2 missing: sc-girsanov, sc-ito-formula
- `sp-martingale-convergence` (stochastic-processes-and-martingales) — 2 missing: martingales, random-variables
- `sp-continuous-martingales` (stochastic-processes-and-martingales) — 2 missing: martingales, sc-ito-integral
- `sc-girsanov` (stochastic-calculus) — 2 missing: sc-ito-integral, brownian-motion

## Top 20 dangling proper-noun phrases (by topic count)

- "Interactive Mathematics Notebook" — in **13** topics
- "The Euler" — in **6** topics
...
Compact roll-up of the rows above. Bucket: 🟢 healthy (no implicit flags, ≤1 dead-end), 🟡 minor, 🔴 attention. Summary: 11 🟢 · 74 🟡 · 20 🔴.

| topic | concepts | dead-ends | orphans | implicit | multi-topic | bucket |
|---|---:|---:|---:|---:|---:|:---:|
| `category-theory` | 12 | 3 | 0 | 7 | 1 | 🔴 |
| `characteristic-classes` | 6 | 4 | 0 | 1 | 1 | 🔴 |
| `commutative-algebra` | 13 | 4 | 0 | 1 | 0 | 🔴 |
| `complex-analysis` | 26 | 3 | 0 | 8 | 4 | 🔴 |
...
| `intersection-theory-chow` | 6 | 2 | 0 | 5 | 0 | 🔴 |
...
| `stochastic-processes-and-martingales` | 6 | 1 | 0 | 6 | 0 | 🔴 |
| `algebra` | 12 | 2 | 0 | 2 | 0 | 🟡 |
...
| `analytic-number-theory` | 6 | 3 | 0 | 1 | 0 | 🟡 |
...
| `functional-analysis` | 12 | 2 | 0 | 3 | 2 | 🟡 |
