...
- Widgets: **452** (registry-driven: 10, inline: 442)
...
- Topics: **1**, concepts: **5**
- Widgets: **4** (registry-driven: 0, inline: 4)
  - by family: unknown: 4
  - by dimension: unknown: 4
  - by gesture: unknown: 4
...
- Widgets: **65** (registry-driven: 10, inline: 55)
  - by family: unknown: 55, clickable-diagram: 8, naturality-square: 1, button-stepper: 1
  - by dimension: unknown: 55, 2d: 10
  - by gesture: unknown: 55, click: 9, slider+click: 1
...
- Widgets: **78** (registry-driven: 0, inline: 78)
  - by family: unknown: 78
  - by dimension: unknown: 78
  - by gesture: unknown: 78
...
- `naive-set-theory` (Foundations) — concepts=5, widgets=4 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
- `algebra` (Algebra) — concepts=12, widgets=12 (slug=0), quiz=73 (v1=36, hard=37, expert=0)
...
- `commutative-algebra` (Algebra) — concepts=12, widgets=12 (slug=0), quiz=71 (v1=36, hard=35, expert=0)
- `homological` (Algebra) — concepts=12, widgets=11 (slug=0), quiz=73 (v1=36, hard=37, expert=0)
- `real-analysis` (Analysis) — concepts=14, widgets=14 (slug=0), quiz=71 (v1=42, hard=29, expert=0)
- `measure-theory` (Analysis) — concepts=12, widgets=12 (slug=0), quiz=72 (v1=36, hard=36, expert=0)
- `complex-analysis` (Analysis) — concepts=26, widgets=7 (slug=0), quiz=28 (v1=16, hard=12, expert=0)
- `functional-analysis` (Analysis) — concepts=12, widgets=11 (slug=0), quiz=72 (v1=36, hard=36, expert=0)
...
- `riemannian-geometry` (Geometry & topology) — concepts=5, widgets=7 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
...
- `frobenius-and-reciprocity` (Number theory) — concepts=5, widgets=6 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
- `class-field-theory` (Number theory) — concepts=6, widgets=8 (slug=0), quiz=36 (v1=18, hard=18, expert=0)
- `upper-half-plane-hyperbolic` (Modular forms & L-functions) — concepts=5, widgets=7 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
- `modular-forms` (Modular forms & L-functions) — concepts=5, widgets=7 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
- `theta-functions` (Modular forms & L-functions) — concepts=5, widgets=7 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
...
- `stacks` (Algebraic geometry) — concepts=5, widgets=7 (slug=0), quiz=30 (v1=15, hard=15, expert=0)
