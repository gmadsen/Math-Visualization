...
- Widgets: **1524** (registry-driven: 1524, inline: 0)
...
- Concepts lacking a widget in their section: **77**
...
- `bezout` (Algebraic geometry) — concepts=5, widgets=9 (slug=9), quiz=30 (v1=15, hard=15, expert=0)
