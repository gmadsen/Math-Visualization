...
- Concepts lacking a widget in their section: **165**
...
- `groebner-bases` (Algebra & homological) — concepts=8, widgets=0 (slug=0), quiz=24 (v1=24, hard=0, expert=0)
...
- `solving-polynomial-systems` (groebner-bases)
