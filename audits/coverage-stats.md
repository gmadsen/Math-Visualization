...
- Widgets: **1593** (registry-driven: 1593, inline: 0)
...
- Widgets: **224** (registry-driven: 224, inline: 0)
  ...
  - by gesture: click: 94, slider: 78, interact: 35, select: 8, drag: 5, edit: 1, timeline: 1, step: 1, static: 1
...
- `algebraic-topology` (Geometry & topology) — concepts=6, widgets=7 (slug=7), quiz=32 (v1=18, hard=14, expert=0)
