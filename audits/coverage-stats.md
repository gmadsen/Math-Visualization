...
- Widgets: **1466** (registry-driven: 1466, inline: 0)
...
- Concepts lacking a widget in their section: **135**
...
- `complex-analysis` (Analysis) — concepts=27, widgets=11 (slug=11), quiz=52 (v1=40, hard=12, expert=0)
