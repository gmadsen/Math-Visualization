...
- Widgets: **1486** (registry-driven: 1486, inline: 0)
...
- Concepts lacking a widget in their section: **115**
...
- `advanced-complex-analysis` (Analysis) — concepts=13, widgets=9 (slug=9), quiz=39 (v1=39, hard=0, expert=0)
