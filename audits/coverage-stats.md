...
- Widgets: **1464** (registry-driven: 1464, inline: 0)
...
- `complex-analysis` (Analysis) — concepts=27, widgets=9 (slug=9), quiz=52 (v1=40, hard=12, expert=0)
