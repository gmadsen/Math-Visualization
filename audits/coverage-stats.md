...
- Widgets: **65** (registry-driven: 5, inline: 60)
  - by family: unknown: 60, clickable-diagram: 4, naturality-square: 1
  - by dimension: unknown: 60, 2d: 5
  - by gesture: unknown: 60, click: 4, slider+click: 1
...
- `category-theory` (Algebra) — concepts=12, widgets=17 (slug=5), quiz=72 (v1=36, hard=36, expert=0)
