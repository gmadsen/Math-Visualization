...
- Widgets: **1650** (registry-driven: 1650, inline: 0)
...
- `complex-analysis` (Analysis) — concepts=27, widgets=29 (slug=29), quiz=52 (v1=40, hard=12, expert=0)
...
- `dynamical-systems` (Analysis) — concepts=13, widgets=19 (slug=19), quiz=75 (v1=39, hard=36, expert=0)
...
- `differential-geometry` (Geometry & topology) — concepts=5, widgets=12 (slug=12), quiz=30 (v1=15, hard=15, expert=0)
