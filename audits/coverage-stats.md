...
- Widgets: **1521** (registry-driven: 1521, inline: 0)
...
- Concepts lacking a widget in their section: **80**
...
- `operator-algebras` (Analysis) — concepts=12, widgets=14 (slug=14), quiz=72 (v1=36, hard=36, expert=0)
