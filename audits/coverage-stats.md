...
- Widgets: **70** (registry-driven: 70, inline: 0)
  - by family: slider-readout: 32, verbatim: 7, schrodinger-figure: 7, button-stepper: 6, hamiltonians-figure: 6, general-relativity-light-cones: 1, general-relativity-einstein: 1, general-relativity-schwarzschild: 1, general-relativity-kerr: 1, general-relativity-cosmology: 1, general-relativity-gw: 1, three-body-nbody-simulator: 1, three-body-lagrange-points: 1, three-body-special-solutions: 1, three-body-horseshoe: 1, three-body-kam-tori: 1, three-body-halo-orbits: 1
  - by dimension: 2d: 70
  - by gesture: slider: 48, click: 14, interact: 7, drag: 1
...
- Widgets: **59** (registry-driven: 59, inline: 0)
  - by family: slider-readout: 24, parametric-plot: 24, verbatim: 5, button-stepper: 5, inline-code-cell: 1
  - by dimension: 2d: 59
  - by gesture: slider: 52, click: 5, scrub: 1, edit: 1
...
- Widgets: **56** (registry-driven: 56, inline: 0)
  - by family: parametric-plot: 42, slider-readout: 10, verbatim: 3, tda-interval-decomposition: 1
  - by dimension: 2d: 56
...
- `probability-theory` (Probability & statistics) — concepts=12, widgets=12 (slug=12), quiz=73 (v1=36, hard=24, expert=13)
...
- `smooth-manifolds` (Geometry & topology) — concepts=10, widgets=10 (slug=10), quiz=59 (v1=30, hard=29, expert=0)
- `differential-forms` (Geometry & topology) — concepts=5, widgets=7 (slug=7), quiz=30 (v1=15, hard=15, expert=0)
- `differential-geometry` (Geometry & topology) — concepts=5, widgets=11 (slug=11), quiz=30 (v1=15, hard=15, expert=0)
- `riemannian-geometry` (Geometry & topology) — concepts=5, widgets=9 (slug=9), quiz=30 (v1=15, hard=15, expert=0)
...
- `projective-plane` (Algebraic geometry) — concepts=5, widgets=9 (slug=9), quiz=30 (v1=15, hard=15, expert=0)
