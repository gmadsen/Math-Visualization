...
- Widgets: **1645** (registry-driven: 1645, inline: 0)
...
| `vector-field-flow-2d` | vector-field-flow-2d | click-seed | 2d | 6 | deep-learning-theory, dynamical-systems, mathematical-biology |
...
- `dynamical-systems` (Analysis) — concepts=13, widgets=18 (slug=18), quiz=75 (v1=39, hard=36, expert=0)
