...
- Widgets: **1585** (registry-driven: 1585, inline: 0)
...
- Concepts lacking a widget in their section: **16**
...
- `motives` (Algebraic geometry) — concepts=8, widgets=4 (slug=4), quiz=24 (v1=24, hard=0, expert=0)
