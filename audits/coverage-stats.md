...
- Widgets: **1488** (registry-driven: 1488, inline: 0)
...
- Concepts lacking a widget in their section: **113**
...
- `advanced-complex-analysis` (Analysis) — concepts=13, widgets=11 (slug=11), quiz=39 (v1=39, hard=0, expert=0)
