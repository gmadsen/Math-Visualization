...
- Widgets: **1578** (registry-driven: 1578, inline: 0)
...
- Concepts lacking a widget in their section: **23**
...
- Widgets: **175** (registry-driven: 175, inline: 0)
  ...
  - by dimension: 2d: 168, 3d: 7
  - by gesture: click: 94, slider: 40, select: 14, drag: 11, button-stepper: 6, step: 3, pick: 2, static: 2, interact: 1, input: 1, timeline: 1
...
- `functor-of-points` (Algebraic geometry) — concepts=5, widgets=9 (slug=9), quiz=30 (v1=15, hard=15, expert=0)
