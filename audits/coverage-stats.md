...
- Widgets: **1454** (registry-driven: 1454, inline: 0)
...
- Concepts lacking a widget in their section: **147**
...
- `hodge-theory` (Algebraic geometry) — concepts=8, widgets=1 (slug=1), quiz=24 (v1=24, hard=0, expert=0)
