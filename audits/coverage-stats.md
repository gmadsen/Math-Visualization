...
- Widgets: **1656** (registry-driven: 1656, inline: 0)
...
- Widgets: **79** (registry-driven: 79, inline: 0)
  ...
  - by dimension: 2d: 79
  - by gesture: slider: 44, click: 22, step: 5, input: 2, button: 2, click-seed: 1, pour-update: 1, play: 1, toggle: 1
...
- `probability-theory` (Probability & statistics) — concepts=12, widgets=14 (slug=14), quiz=73 (v1=36, hard=24, expert=13)
