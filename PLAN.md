...
- 195 topics, 1350 concepts, 34 capstones
- 150 concepts lack a widget in their owning section
- 1379 widgets, 100% registry-driven. Interactive baseline gated via `audits/static-widgets-baseline.json`
- Quiz tiers: v1 = 4008, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (912 concepts lack hard tier).
