...
- 178 topics, 1236 concepts, 34 capstones
...
- Quiz tiers: v1 = 3666, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (798 concepts lack hard tier).
