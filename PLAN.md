...
3. **Themes / display polish:** light-theme widget eyeball pass (dark-tuned `fill-opacity`/glows wash out); reading-width/font-size knob in `MVDisplay`; per-section accent tinting on topic pages.
