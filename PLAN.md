...
- 203 topics, 1398 concepts, 34 capstones
- 150 concepts lack a widget in their owning section
- 1427 widgets, 100% registry-driven. Interactive baseline gated via `audits/static-widgets-baseline.json`
- Quiz tiers: v1 = 4150, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (960 concepts lack hard tier).
