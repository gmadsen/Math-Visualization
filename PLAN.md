...
- 175 topics, 1215 concepts, 34 capstones
...
- Quiz tiers: v1 = 3603, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (777 concepts lack hard tier).
