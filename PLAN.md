...
- 206 topics, 1416 concepts, 34 capstones
- 150 concepts lack a widget in their owning section
- 1445 widgets, 100% registry-driven. Interactive baseline gated via `audits/static-widgets-baseline.json`
- Quiz tiers: v1 = 4204, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Wave 3 (integrative):** `diffusion-and-score-based-models`, `causal-inference`
...
- **Hard-tier quiz authoring** (978 concepts lack hard tier).
