...
- 177 topics, 1229 concepts, 34 capstones
...
- Quiz tiers: v1 = 3645, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (791 concepts lack hard tier).
