...
- 182 topics, 1264 concepts, 34 capstones
...
- Quiz tiers: v1 = 3750, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (826 concepts lack hard tier).
