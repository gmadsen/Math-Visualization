...
- 179 topics, 1243 concepts, 34 capstones
...
- Quiz tiers: v1 = 3687, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (805 concepts lack hard tier).
