...
- 184 topics, 1278 concepts, 34 capstones
...
- Quiz tiers: v1 = 3792, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (840 concepts lack hard tier).
