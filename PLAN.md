...
- 183 topics, 1271 concepts, 34 capstones
...
- Quiz tiers: v1 = 3771, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (833 concepts lack hard tier).
