...
- 176 topics, 1222 concepts, 34 capstones
...
- Quiz tiers: v1 = 3624, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (784 concepts lack hard tier).
