...
- 187 topics, 1299 concepts, 34 capstones
...
- Quiz tiers: v1 = 3855, hard = 1223, expert = 13 (intentionally bottom-of-list — see "Out of scope")
...
- **Hard-tier quiz authoring** (861 concepts lack hard tier).
